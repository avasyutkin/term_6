...
Rcon = ['00000000', '01000000', '02000000', '04000000', '08000000', '10000000', '20000000', '40000000', '80000000',
        '1b000000', '36000000']
...
def MixColumns(input):
    ...
    for i in input:
        ...
        r[0] = '0' * (2 - len(hex((b[0] ^ int(a[3], 16) ^ int(a[2], 16) ^ b[1] ^ int(a[1], 16)) % 256)[2:])) + hex(
            (b[0] ^ int(a[3], 16) ^ int(a[2], 16) ^ b[1] ^ int(a[1], 16)) % 256)[2:]
        r[1] = '0' * (2 - len(hex((b[1] ^ int(a[0], 16) ^ int(a[3], 16) ^ b[2] ^ int(a[2], 16)) % 256)[2:])) + hex(
            (b[1] ^ int(a[0], 16) ^ int(a[3], 16) ^ b[2] ^ int(a[2], 16)) % 256)[2:]
        r[2] = '0' * (2 - len(hex((b[2] ^ int(a[1], 16) ^ int(a[0], 16) ^ b[3] ^ int(a[3], 16)) % 256)[2:])) + hex(
            (b[2] ^ int(a[1], 16) ^ int(a[0], 16) ^ b[3] ^ int(a[3], 16)) % 256)[2:]
        r[3] = '0' * (2 - len(hex((b[3] ^ int(a[2], 16) ^ int(a[1], 16) ^ b[0] ^ int(a[0], 16)) % 256)[2:])) + hex(
            (b[3] ^ int(a[2], 16) ^ int(a[1], 16) ^ b[0] ^ int(a[0], 16)) % 256)[2:]
...
def InvMixColumns(input):
    ...
    for i in range(len(input)):
        r[i][0] = '0' * (2 - len(hex(int(multiply_by_14[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
            multiply_by_11[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
            multiply_by_13[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
            multiply_by_9[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:])) + hex(
            int(multiply_by_14[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
                multiply_by_11[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
                multiply_by_13[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
                multiply_by_9[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:]
        r[i][1] = '0' * (2 - len(hex(int(multiply_by_9[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
            multiply_by_14[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
            multiply_by_11[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
            multiply_by_13[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:])) + hex(
            int(multiply_by_9[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
                multiply_by_14[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
                multiply_by_11[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
                multiply_by_13[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:]
        r[i][2] = '0' * (2 - len(hex(int(multiply_by_13[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
            multiply_by_9[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
            multiply_by_14[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
            multiply_by_11[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:])) + hex(
            int(multiply_by_13[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
                multiply_by_9[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
                multiply_by_14[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
                multiply_by_11[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:]
        r[i][3] = '0' * (2 - len(hex(int(multiply_by_11[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
            multiply_by_13[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
            multiply_by_9[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
            multiply_by_14[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:])) + hex(
            int(multiply_by_11[int(input[i][0][0], 16)][int(input[i][0][1], 16)], 16) ^ int(
                multiply_by_13[int(input[i][1][0], 16)][int(input[i][1][1], 16)], 16) ^ int(
                multiply_by_9[int(input[i][2][0], 16)][int(input[i][2][1], 16)], 16) ^ int(
                multiply_by_14[int(input[i][3][0], 16)][int(input[i][3][1], 16)], 16))[2:]
